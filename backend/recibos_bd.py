...
def ejecutar_acciones_reci(datos_peticion):
	...
	if  tipo_accion[0] ==  'INSERTAR':	
		...
		base_datos = BdatosRecibos(conexion_datos[0], conexion_datos[1], 
							conexion_datos[2], conexion_datos[3])
		errores = base_datos.insertar_filas(campos, datos)

		if errores:
			errores_format = formatear_datos(errores)
	...
	if tipo_accion[0] == 'CONSULTAR':			
		...
		base_datos = BdatosRecibos(conexion_datos[0], 
